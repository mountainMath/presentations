...
subtitle: "Using data to answer our housing questions"
...
```{r canada_age, fig.height=3, fig.width=9, message=FALSE, warning=FALSE, dev='svg'}
library(cancensus)
...
```{r, echo=FALSE, fig.height=4, fig.width=5, message=FALSE, warning=FALSE, dev='svg'}
...
ggplot(geos) +
  ...
  ggtitle(paste0(cma, " CMA Completions May 2016 - October 2017 (",prettyNum(total,big.mark = ",")," total)")) +
  theme_opts
```
...
ggplot() +
  ...
  labs(title="July - October 1 Bedroom Unfurnished Median Ask") +
  theme_opts
```
---
...
g1 <- ggplot(data, 
  ...
  scale_y_continuous(labels = scales::percent) +
  labs(x="Year", title="Average Shelter cost to Median Income") +
