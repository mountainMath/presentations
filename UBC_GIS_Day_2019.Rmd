...
---
## Upshot
* Analysis is transparent and fully reproducible, from pulling in the data, performing the analysis, to displaying the results.
* Can easily repeat for different regions, just swap out the region selection up top.
* Mixing in PUMF data and running an ecological inference provides an overview.
* Can iterate and go deeper, provides base to pull a targeted custom tabulation to solidify results.
* Cartography is passable, can be refined further and made prettier if needed.

And all the code is available for copy-paste for the next project.

In fact, the code is embedded in these slides, what you saw is direct output from the code. You can find the markdown code for the slides on GitHub.
