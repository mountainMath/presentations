...
With so much data, and so much existing research, how do we move forward? My answer to this is to emphasize the following related features when analyzing data:
...
Sharing your code makes it unequivocally clear what you did, it keeps you honest, and it allows others to build on your work. Different people have different perspectives, make different assumptions and different choices in their analysis. Sharing your code makes it easy for others to build on your work and improve it.
